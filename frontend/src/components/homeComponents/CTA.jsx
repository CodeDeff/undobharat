    ...
    <section className="py-16 bg-blue-600 text-white" id="report">
        <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link to="/user/reportnow" className="bg-white hover:bg-gray-100 text-blue-600 px-8 py-3 rounded-md font-bold text-lg transition duration-300">Report an Issue Now</Link>
